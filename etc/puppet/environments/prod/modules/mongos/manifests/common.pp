class mongos::common {
    ...
    $common_packages = [ 'python', 'openssl', 'libcrypto++9v5', 'libboost-regex1.58.0', 'libgoogle-glog0v5', 'libtbb2', 'librados2', 'librados-dev', 'software-properties-common', 'libboost-thread1.58.0', 'unzip', 'zip', 'nfs-common' ]
